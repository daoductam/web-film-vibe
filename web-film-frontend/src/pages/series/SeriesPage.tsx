...
export const SeriesPage = () => {
    ...
    // Hero Data (Just pick the first movie/series for now as featured)
        ...
        <div className="bg-obsidian text-text-primary font-sans overflow-x-hidden antialiased selection:bg-neon selection:text-obsidian min-h-screen flex flex-col">
            ...
            <main className="flex-1">
                        ...
                        {featuredMovie ? (
                            <div className="max-w-3xl space-y-6 animate-fade-in-up">
                                <div className="flex flex-wrap gap-3 items-center">
                                    ...
                                    <span className="text-gray-300 text-sm font-medium">{featuredMovie.year} • {featuredMovie.countries?.[0]?.name} • {featuredMovie.currentEpisode}</span>
                ...
                <section className="max-w-[1600px] mx-auto px-6 py-12">
                    <h2 className="text-2xl font-serif font-bold text-white mb-8 border-l-4 border-neon pl-4">Phim Bộ Mới Cập Nhật</h2>
