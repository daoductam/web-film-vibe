            ...
            <div className="relative z-20 w-full max-w-md px-6">
                <div className="bg-[#191923]/60 backdrop-blur-xl border border-[#00f3ff]/30 rounded-3xl p-8 md:p-10 shadow-[0_8px_32px_0_rgba(0,0,0,0.37)] animate-[fadeInUp_0.8s_ease-out_forwards] shadow-[0_0_15px_rgba(0,243,255,0.15),inset_0_0_5px_rgba(0,243,255,0.05)]">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        ...
                        <h2 className="text-3xl font-serif font-bold text-white mt-2">Đăng nhập</h2>
                        <p className="text-text-secondary text-sm mt-2">Chào mừng trở lại với thế giới điện ảnh</p>
                    </div>
                    ...
                    <form className="space-y-6" onSubmit={handleLogin}>
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center space-x-2 cursor-pointer group">
                                <input 
                                    className="form-checkbox rounded border-gray-600 bg-white/5 text-neon focus:ring-neon focus:ring-offset-0 transition-all duration-200" 
                                    type="checkbox"
                                />
                                <span className="text-gray-400 group-hover:text-white transition-colors select-none">Ghi nhớ đăng nhập</span>
                            </label>
                            <Link to="/forgot-password" title='Tính năng đang phát triển' className="text-neon hover:text-white transition-colors font-medium">Quên mật khẩu?</Link>
                        </div>
                        <button 
                    ...
                    <div className="relative my-8">
                        ...
                        <div className="relative flex justify-center text-xs uppercase">
                            <span className="bg-[#131720] px-2 text-text-secondary rounded">Hoặc đăng nhập bằng</span>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-text-secondary text-sm">
                            Bạn mới tham gia CineStream? 
                            <Link to="/register" className="text-white font-bold hover:text-neon transition-colors ml-1">Đăng ký ngay</Link>
                        </p>
                    </div>
                </div>
