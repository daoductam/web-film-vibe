...
export const HeroSection = () => {
    ...
    return (
        <section className="relative w-full min-h-[500px] md:h-screen md:min-h-[800px] flex items-center overflow-hidden">
            ...
            <div className="relative z-20 container mx-auto px-4 md:px-6 pt-24 md:pt-20 pb-16 md:pb-24 max-w-[1600px]">
                <div className="max-w-3xl space-y-6 md:space-y-8">
                    <div className="flex flex-wrap gap-2 md:gap-3 items-center opacity-0 animate-[fadeIn_0.8s_ease-out_forwards]">
                        ...
                        <span className="flex items-center gap-1 text-yellow-400 text-xs md:text-sm font-bold">
                            <Star className="w-3 h-3 md:w-4 md:h-4 fill-current" /> {heroMovie.averageRating?.toFixed(1) || '0.0'}
                        </span>
                    ...
                    <h1 className="font-serif text-3xl sm:text-5xl md:text-7xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-br from-white via-white to-gray-400 leading-[1.1] md:leading-none drop-shadow-2xl opacity-0 animate-[fadeInUp_1s_0.2s_ease-out_forwards] translate-y-4 line-clamp-3">
                        {heroMovie.title}
                    </h1>
